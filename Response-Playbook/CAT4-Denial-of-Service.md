...
**Play ID.** CAT4-Denial-of-Service.

**Task.** Respond to a CAT 4 (Denial of Service) cyber incident.

**When to Run This Play.** Run this play if one or more of the following is detected: activity that denies, degrades, or disrupts the normal functionality of a computer or network. 

**Purpose.** The purpose of this play is to preserve evidence and minimize operational impact while guiding the Incident Response Team through containment, eradication, and recovery efforts during a denial of service. 
...
**Standards.** The Incident Response Team was able to contain, eradicate, and recover from a CAT 4 cyber incident.
