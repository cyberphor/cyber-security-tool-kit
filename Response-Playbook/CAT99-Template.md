...
**Play ID.** CAT99-Template.

**Task.** Respond to a CAT 99 (Template) cyber incident.

**When to Run This Play.** Run this play if one or more of the following is detected: (1) foo, (2) bar, or (3) foo-bar. 

**Purpose.** The purpose of this play is to preserve evidence and minimize operational impact while guiding the Incident Response Team through containment, eradication, and recovery efforts during a foo-bar incident. 
...
**Standards.** The Incident Response Team was able to contain, eradicate, and recover from a CAT 99 cyber incident.
